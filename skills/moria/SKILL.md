...
Read `mend_repos.md` from the project memory directory — the same place
`repo_routing.md` and `default_filters.md` live. Its body is a flat list of absolute
repo roots, one per line (a leading `- ` is optional):
